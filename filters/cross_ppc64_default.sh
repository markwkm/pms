...
export ARCH=ppc64
export CC_ARCH=powerpc64
export CROSS_COMPILE=${CC_ARCH}-unknown-linux-gnu-
export PATH=$PATH:/var/crosstool/${CC_ARCH}-unknown-linux-gnu/gcc-3.4.0-glibc-2.3.2/bin
